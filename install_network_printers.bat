...
cscript %WINDIR%\System32\Printing_Admin_Scripts\en-US\Prnport.vbs -a -r IP_10.20.30.10 -h 10.20.30.10 -o raw -n 9100
...
rundll32 printui.dll,PrintUIEntry /if /b "Name of printer" /f "C:\path\to\driver.inf" /r "IP_10.20.30.10" /m "Name of driver"
